...
//Matrices suma/resta/multiplicaci�n
float matriz1[50][50];
float matriz2[50][50];
...
//[Y][X]
float matrizTras[4][4]; //Matriz Traslaci�n
float matrizRot[4][4]; //Matriz Rotaci�n
...
void OperacionesSimples(); //Suma, resta y multiplicaci�n
void MatricesCompuestas(); //Rotaci�n, Traslaci�n, Escalaci�n
void SumaMatrices();
void RestaMatrices();
